...
import com.etl.overtimebd.DbHelper.DbHelper;
import com.etl.overtimebd.Layout.FounderPage;
        ...
        switch (item.getItemId()){
            ...
            case R.id.share:
                try {
                    ...
                    String shareMessage;
                    shareMessage = "\nTracking,Counting and Calculating Overtime data\n\n" + "https://www.facebook.com/" + BuildConfig.APPLICATION_ID +"\n\n";
            ...
            case R.id.outt:
               ...
               Intent intentt=new Intent(MyMainActivity.this,LoginSignup.class);
